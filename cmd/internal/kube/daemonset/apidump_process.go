...
func (d *Daemonset) StartApiDumpProcess(podUID types.UID) error {
	...
	go func() (funcErr error) {
		...
		apidumpArgs := apidump.Args{
			...
			Interfaces:              podArgs.Interfaces,
			Filter:                  podArgs.Filter,
			HostAllowlist:           podArgs.HostAllowlist,
			HostExclusions:          podArgs.HostExclusions,
			PathAllowlist:           podArgs.PathAllowlist,
			PathExclusions:          podArgs.PathExclusions,
