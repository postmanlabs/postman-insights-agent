...
//
// It attaches libssl uprobes (and, with --enable-javatls, the java_tls kprobe)
// and prints REQ/RESP lines to stdout — no Postman API key required. Useful for
// local smoke-testing eBPF capture without a backend connection.
//
...
Attaches libssl uprobes for OpenSSL-based runtimes. With --enable-javatls also
attaches the java_tls kprobe for JVM traffic. All output goes to stdout.
