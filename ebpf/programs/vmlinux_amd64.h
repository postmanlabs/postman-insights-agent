 ...
 *
 * The real header is a multi-megabyte BTF dump of the amd64 kernel and must be
 ...
 */
#error "vmlinux_amd64.h is a placeholder — run ebpf/programs/gen-vmlinux.sh on a Linux host and commit the real header."
