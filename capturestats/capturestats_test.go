...
func TestNilStatsIsSafe(t *testing.T) {
	...
	assert.NotPanics(t, func() {
		...
		s.IncrRequestsRateLimited()
		s.AddRequestKeysExpired(1)
		s.IncrRequestsDroppedAgentTraffic()
		s.IncrResponsesDroppedAgentTraffic()
		s.IncrRequestsDroppedNginxTraffic()
		s.IncrResponsesDroppedNginxTraffic()
		s.IncrResponsesDroppedNoMatchingRequestRateLimited()
		s.IncrResponsesDroppedNoMatchingRequestExpired()
		s.IncrResponsesDroppedNoMatchingRequestActiveRequestStream()
		s.IncrResponsesDroppedNoMatchingRequestResponseFirst()
		s.IncrResponsesDroppedNoMatchingRequestRequestSeenLocalCollector()
		s.IncrResponsesDroppedNoMatchingRequestRequestSeenOtherCollector()
		s.IncrResponsesDroppedNoMatchingRequestUnknown()
